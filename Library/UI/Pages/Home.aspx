    ...
    <div class="container">
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile">
                ...
                <div runat="server" id="ADMINISTRADORES" class="tile-num full-reset"></div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
                <div class="tile-name all-tittles">estudiantes</div>
                <div runat="server" id="ESTUDIANTES" class="tile-num full-reset"></div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-male-alt"></i></div>
                <div class="tile-name all-tittles">docentes</div>
                <div runat="server" id="DOCENTES" class="tile-num full-reset"></div>
            </article>
            <article class="tile">
            ...
            <article class="tile">
                ...
                <div runat="server" id="DEVOLUCIONES_PENDIENTES" class="tile-num full-reset"></div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-calendar"></i></div>
                <div class="tile-name all-tittles">préstamos</div>
                <div runat="server" id="PRESTAMOS" class="tile-num full-reset"></div>
            </article>
            <article class="tile">
