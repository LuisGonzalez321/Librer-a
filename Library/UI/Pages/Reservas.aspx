<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Pages/Site1.Master" AutoEventWireup="true" CodeBehind="Reservas.aspx.cs" Inherits="Library.UI.Pages.Reservas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li class="active"><a href="Reservas.aspx" style="font-size:15px">Nueva Reservación</a></li>
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                            ...
                            <p class="text-center">
                                ...
                                <asp:Button runat="server" type="submit" class="btn btn-primary" Text="Guardar" OnClick="btn_guardarE_Click"/><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; 
                            </p> 
                       </div>
                    </div>
