                ...
                <form autocomplete="off" runat="server">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <div class="group-material">
                                <asp:TextBox runat="server" ID="txt_dirección" type="text" CssClass="material-control tooltips-general" placeholder="Escribe aquí la dirección del personal" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Escriba una dirección válida"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                           ...
                           <legend>Turno y Sección encargada</legend>
                            <div class="group-material">
                                ...
                                <asp:DropDownList ID="lista_sección" runat="server" class="material-control tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige la sección encargada del docente">
                                    <asp:ListItem selected="False">Selecciona una sección</asp:ListItem>
                                    <asp:ListItem value="Seccion">A</asp:ListItem>
                                    <asp:ListItem value="Seccion">B</asp:ListItem>
                                    <asp:ListItem value="Seccion">C</asp:ListItem>
                                    <asp:ListItem value="Seccion">D</asp:ListItem>
                                </asp:DropDownList>

                            </div>
                            <div class="group-material">
                                <span>Turno</span>
                                <asp:DropDownList ID="lista_turno" runat="server" class="material-control tooltips-general" data-toggle="tooltip" data-placement="top" title="Elige el turno que labora el docente">
                            ...
                            <p class="text-center">
                                ...
                                <asp:Button runat="server" id="btn_guardard" type="submit" class="btn btn-primary" Text="Guardar" OnClick="btn_guardard_Click"/><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp;
                            </p> 
                        </div>
                    </div>
                </form>
