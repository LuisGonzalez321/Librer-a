                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <asp:TextBox runat="server" CssClass="material-control tooltips-general" placeholder="Escribe aquí el código de categoría"  pattern="[0-9]{1,20}" maxlength="20" data-toggle="tooltip" data-placement="top" ID="txt_cod"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Código de categoría</label>
                            </div>
                            <div class="group-material">
                                <asp:TextBox runat="server" CssClass="material-control tooltips-general" placeholder="Escribe aquí el nombre de la categoría"  pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" ID="txt_nombre"></asp:TextBox>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre</label>
                            </div>
                            <p class="text-center">
                                <asp:Button runat="server" Text="Limpiar"  class="btn btn-info" style="margin-right: 20px;"/><i class="zmdi zmdi-roller"></i> &nbsp;&nbsp;
                                <asp:Button runat="server" Text="Guardar"  class="btn btn-primary" ID="btn_guardar" OnClick="btn_guardar_Click"/><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp;
                            </p> 
                       </div>
                    </div>
                </form>
