    ...
    <div class="container">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <p class="text-center">
                                ...
                                <asp:Button runat="server" id="btn_guardar" type="submit" CssClass="btn btn-primary" Text="Guardar" OnClick="btn_guardar_Click"/>  <i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp;
                            </p> 
                        </div>
                    </div>
                </form>
       ...
       <script type="text/javascript">
           function MostrarMensaje(estado) {
               if (estado == 1) { alert("Ingreso Exitoso!!"); }
